...
import MyClassType 1.0 //导入

// 测试WebGL支持：http://get.webgl.org
// 功能测试页：F:/qt/qt_program/untitled1qml/resource/index.html
// 智慧屏Pad端html路径：/usr/share/web/pad/build/index.html
// 音速屏Pad端html路径：/usr/share/fluidd-pad/index.html
// klipper音速屏html路径：http://127.0.0.1
// 智慧屏默认right方向，Klipper默认bottom方向

Item {
    id: window
    visible: true
    property int device: 2            // 1-智慧屏  2-音速屏
...
//        id: screensaver
//        anchors.fill: parent
//        source: "/usr/share/fluidd/horizontal.png"
//    }

    // 创建cpp的通信对象
    MyClass {
        id: myobj;
        WebChannel.id: "qtObject"   // 前端获取的对象名称
    }
    ...
    */
    ...
    Connections {
        ...
        onContextMenuRequested: {
            request.accepted = true;    // 禁用右键菜单：防止默认上下文菜单显示
        }
        onLoadingChanged: {
            // 读取配置文件获取窗口方向
